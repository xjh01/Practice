<template>
	<div class="list">
		...
		<el-table :data="fapiData" style="width: 100%;margin: 0 auto;" highlight-current-row border tooltip-effect="dark" :header-cell-style="tableHeaderColor">
			<el-table-column>
				...
				<el-table-column label="操作" fixed="right" width="100" header-align="center" align="left">
					<template slot-scope="scope">
						...
						<el-tooltip content="编辑" placement="top">
							<i class="icon el-icon-edit-outline" @click="editMember(scope)"></i>
						</el-tooltip>
	...
	export default {
		...
		methods: {
			test(){
				...
				xAxios.getAdd('post','/member_userinfo/add',data)
